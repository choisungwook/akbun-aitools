...
| [akbun-analysis-token-credential](./plugins/akbun-analysis/skills/akbun-analysis-token-credential/) | 토큰·API 키 같은 자격 증명을 보안 관점에서 볼 때 발급 주체·읽는 주체·허용 범위를 묻는 질문 한 줄. 모델 자동 호출 가능 |
