...
파일/폴더 레이아웃 다이어그램 지원 skill 모음.

| skill | 설명 |
|---|---|
| [akbun-draw-file-tree](./plugins/akbun-design/skills/akbun-draw-file-tree/) | 디렉터리 트리를 파일/폴더 레이아웃 다이어그램의 이미지 생성 프롬프트와 Figma/Canva용 SVG로 작성 |
...
/plugin install akbun-design@akbun-aitools
/reload-plugins
```
...
codex plugin add akbun-design@akbun-aitools --json
```
...
codex plugin remove akbun-design@akbun-aitools --json
