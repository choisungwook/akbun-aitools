...
| [akbun-draw-poster-reaction](./plugins/akbun-writing/skills/akbun-draw-poster-reaction/) | 상황을 한 컷 리액션 포스터(인물+모니터 속 대상+말풍선)로 만드는 이미지 생성 프롬프트와 Figma/Canva용 SVG 작성 |
