...
`akbun-draw-component`(하이레벨 아키텍처)와 짝이 되는, "개념 카드 일러스트" 버전이다. 다이어그램이 아니라 **한 장면의 그림으로 개념을 각인시키고 싶을 때** 쓴다. 인스타그램 카루셀, 블로그 표지, 시리즈물 카드에 어울린다.
...
- 장면에 인물·캐릭터가 필요하면 소재에 맞는 인물·캐릭터를 정해 연필 스타일로 그린다.
