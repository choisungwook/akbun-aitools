...
기본 마스코트는 **akbun 마스코트 고래**다. 캐릭터가 1마리인 자리는 항상 고래다.

- 외형과 표정·포즈 어휘는 **`akbun-mascot-whale` skill의 캐릭터 스펙을 그대로 따른다** — 콩 모양의
  둥근 몸통, 흰 배, 밝은 회색 등, 작은 옆지느러미 2개, 납작한 꼬리, 까만 점 눈 2개, 작은 곡선 입,
  두껍고 둥근 손그림 외곽선.
...
- **비율**: 세로형 4:5, 가로 1080 × 세로 1350 (SVG viewBox `0 0 1080 1350`, 인스타그램 세로형). 흰 바탕.
...
```text
ONE single hand-drawn black-and-white cheatsheet poster, portrait 4:5 (1080x1350),
...
- `viewBox="0 0 1080 1350"`, 외부 이미지·스크립트 없는 순수 SVG 1.1로 작성한다. Figma와 Canva가 그대로 불러온다.
