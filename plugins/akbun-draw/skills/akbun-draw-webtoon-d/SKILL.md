...
다른 웹툰 skill과의 구분: `akbun-draw-webtoon-b`는 세로형 파스텔 치비 페이지, `akbun-draw-webtoon-c`는 세로형 1컷 에세이툰(고래 마스코트)이다. 이 skill은 **세로형 3:4(인스타 피드) + 하단 자막 내레이션 + 흑백 낙서선 + 사람 캐릭터**가 고정이다.
