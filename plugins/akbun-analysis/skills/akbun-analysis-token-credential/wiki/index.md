# akbun-analysis-token-credential Wiki
...
Holds one security question for credentials (tokens, API keys, certificates, service accounts): who issued it, who reads it, and what it permits. Model-invocable so it surfaces whenever a credential appears in analyzed code, config, or infrastructure.
