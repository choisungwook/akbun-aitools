...
Creates a single-page DR (Disaster Recovery) plan for an IT system from code, documentation, an optional onboarding document, and a focused interview when explicitly requested.
