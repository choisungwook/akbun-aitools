...
Creates a single-page, beginner-level install manual for a solution or open-source product: short intro, Mermaid architecture/network diagrams, prerequisites, cautions, numbered step-by-step install, verification, and cleanup.
