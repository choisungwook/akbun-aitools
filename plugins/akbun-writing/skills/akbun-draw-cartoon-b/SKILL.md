...
캔버스는 **세로형 카드**다. 기본 `1080×1215`(약 8:9). 요소를 억지로 고정 좌표에 두지 않되, 참고 카드의
**상하좌우 간격 비율**을 지킨다.
...
```text
A vertical issue "card-news" illustration (portrait, about 8:9), in a naive childlike doodle
...
```xml
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1080 1215" width="1080" height="1215">
  ...
  <!-- 배경 그라데이션 -->
  <rect width="1080" height="1215" fill="url(#bg)"/>
  <!-- 얇은 베이지 테두리 액자 -->
  <rect x="22" y="22" width="1036" height="1171" fill="none" stroke="#CBB994" stroke-width="4"/>
