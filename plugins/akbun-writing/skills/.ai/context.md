...
- explainer video(해설 영상): 어두운 배경(`#0d1117`) 위 도형·화살표·수식이 순차 등장하는 개념 해설 MP4다. HyperFrames(HTML → MP4 오픈소스)로 렌더링하며, 스타일 토큰은 고정하고 주제·구도는 입력에 맞춘다. `akbun-make-explainer-video`가 담당한다.
